      ...
      <div className="app">
        ...
        {phase === "result" && scores && (
          <div className="results-section">
            ...
            {/* Your Score label */}
            <div style={{ fontFamily: "'Outfit', sans-serif", fontSize: "11px", fontWeight: 700, letterSpacing: "1.5px", textTransform: "uppercase", color: "#888", marginBottom: "6px", marginTop: "4px" }}>Your Score</div>
