...
const scenarios = [
  ...
  },
  {
    ...
    correctRuling: "No. A player's word alone is not grounds to reverse a decision. Consult your assistant, if they saw nothing, the penalty stands. Law 5 permits changes before restart, but only on the referee's own realisation or on advice from an assistant or fourth official. An opposing player, however calm, is not a valid source.",
...
const bonusScenarios = [
  ...
  },
  {
    ...
    minute: "93'",
    stakes: "Relegation decider",
    setup: "You award a penalty in the 93rd minute. As the taker places the ball, you notice the goalkeeper has a smartwatch on her wrist, partially hidden under tape. You call her over. She says she has a heart condition and her doctor has instructed her to wear it at all times to monitor her heart rate. She shows you a medical band on her other wrist. She says she wore it in last week's match without issue. The penalty is waiting.",
    question: "What do you do next?",
